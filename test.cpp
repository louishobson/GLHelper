...
int main ()
{
    ...
    glh::renderer::clear_color ( 1.0, 0.0, 1.0, 1.0 );
    ...
    lighting_uni.get_uniform ( "point_size" ).set_int ( 0 );
    ...
    lighting_uni.get_array_uniform<glh::struct_uniform> ( "directional" ).at ( 0 ).get_uniform ( "ambient_color" ).set_vector ( glh::math::vec3 { 0.1, 0.1, 0.1 } );
    lighting_uni.get_array_uniform<glh::struct_uniform> ( "directional" ).at ( 0 ).get_uniform ( "diffuse_color" ).set_vector ( glh::math::vec3 { 0.5, 0.5, 0.5 } );
    lighting_uni.get_array_uniform<glh::struct_uniform> ( "directional" ).at ( 0 ).get_uniform ( "specular_color" ).set_vector ( glh::math::vec3 { 1.0, 1.0, 1.0 } );
    ...
    while ( !window.should_close () ) 
    {
        ...
        factory.render ( material_uni, model_uni, glh::math::resize<4> ( glh::math::rotate ( glh::math::enlarge ( glh::math::identity<3> (), 0.1 ), glh::math::rad ( 90 ), 1, 2 ) ) );
